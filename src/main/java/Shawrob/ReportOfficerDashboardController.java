...
public class ReportOfficerDashboardController
{
    ...
    public void auditTrailOnAction(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/Shawrob/auditTrail-view.fxml"));
    ...
    public void dormantAccountsOnAction(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/Shawrob/dormantAccounts-view.fxml"));
        reportOfficerDashboardBP.setCenter(fxmlLoader.load());
    }

    @javafx.fxml.FXML
    public void settlementReportOnAction(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/Shawrob/settlementReport-view.fxml"));
        reportOfficerDashboardBP.setCenter(fxmlLoader.load());
    }

    @javafx.fxml.FXML
    public void corporateActionOnAction(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/Shawrob/corporateAction-view.fxml"));
        reportOfficerDashboardBP.setCenter(fxmlLoader.load());
    }
    ...
    public void holdingsReportOnAction(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/Shawrob/holdingsReport-view.fxml"));
        reportOfficerDashboardBP.setCenter(fxmlLoader.load());
    }

    @javafx.fxml.FXML
    public void dailySummaryOnAction(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/Shawrob/dailySummary-view.fxml"));
        reportOfficerDashboardBP.setCenter(fxmlLoader.load());
    }

    @javafx.fxml.FXML
    public void scheduleReportOnAction(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/Shawrob/scheduleReport-view.fxml"));
        reportOfficerDashboardBP.setCenter(fxmlLoader.load());
    }

    @javafx.fxml.FXML
    public void boActivityOnAction(ActionEvent actionEvent) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("/Shawrob/boActivity-view.fxml"));
        reportOfficerDashboardBP.setCenter(fxmlLoader.load());
    }
}